<template>
	<view class="home-container">
		home页面
		<customVirtualiList :columns="2" :dataList="dataList" :pageSize="pageSize" class="test"
            ...
            " class="goods-image">
					...
					<view class="description">
						<view class="description-header">
							<view v-if="virtualItem.spuBrand" class="spuBrand van-ellipsis">{{ virtualItem.spuBrand }}
							</view>
						...
						<view class="description-footer">
							<text v-if="virtualItem.minSkuPriceStr" class="minSkuPriceStr van-ellipsis" :style="{
                  color: virtualItem.salePrice ? '#999999' : '#031c24',
                }">¥{{ virtualItem.minSkuPriceStr }}</text>
							<text v-if="virtualItem.salePrice"
								class="salePrice van-ellipsis">{{ virtualItem.salePrice }}</text>
						</view>
					</view>
				</view>
			</template>
